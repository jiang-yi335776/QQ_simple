...
public:
    ...
    void setupUi(QWidget *TalkWindow)
    {
        ...
        horizontalSpacer_2 = new QSpacerItem(516, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 258, 335));
